...
SUBJECT_LIST="${HOME}/clinical_dmri_benchmark/analysis/data_processing/subject_lists/preprocessed_subject_list_GQIautotrack.txt"
...
RECON_SPEC="${HOME}/clinical_dmri_benchmark/analysis/data_processing/recon_specs/gqi_autotrack.yaml"
...
mv -v "${PWD}/results/derivatives/qsirecon-GQIautotrack/${subid}"/* "${OUTPUTS}/${subid}/"
mv "${PWD}/results/derivatives/qsirecon-GQIautotrack/${subid}.html" "${OUTPUTS}/${subid}.html"
echo SUCCESS
